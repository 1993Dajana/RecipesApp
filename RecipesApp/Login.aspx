<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Login" 
    ...
    <div>
        ...
        <asp:Login ID="loginComp" runat="server" CreateUserUrl="~/Register.aspx" DestinationPageUrl="~/Homepage.aspx" OnLoggedIn="loginComp_LoggedIn">
            <LayoutTemplate>
                            ...
                            <table cellpadding="0">
                                ...
                                <tr>
                                    <td align="right" colspan="2">
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <asp:Button ID="LoginButton" runat="server" CommandName="Login" Text="Log In" ValidationGroup="loginComp" />
                                    </td>
                                </tr>
                            </table>
                        </td>
